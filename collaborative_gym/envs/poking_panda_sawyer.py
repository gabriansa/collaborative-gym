...
class PokeTaskPandaSawyerEnv(BaseEnv, MultiAgentEnv):
    def __init__(self):
        self.my_robots = {}
        self.obs_len_robots = {}
        ...
        super(PokeTaskPandaSawyerEnv, self).__init__()
    ...
    def reset(self):
        super(PokeTaskPandaSawyerEnv, self).reset()
        self.create_world()

        # Position robot 1 on a table
        self.my_robots['robot_1'].set_base_pos_orient([0,-1,0.65], [0,0,np.pi/3])
        self.table= Object()
        self.table.init('table', self.directory, self.id, self.np_random)
        self.table.set_base_pos_orient([0,-1,0], [0,0,np.pi/2])

        # Position robot 2 and assign donut object
        self.my_robots['robot_2'].set_base_pos_orient([0,0.8,1], [0,0,-np.pi/3])
